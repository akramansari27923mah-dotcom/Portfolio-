        ...
        <nav className=' text-white fixed top-0 z-10 w-full flex justify-between items-center border-b-gray-300 border-b-[0.5px] bg-black/70 px-10 py-4 md:justify-evenly backdrop-blur-md'>
            ...
            transition={{duration:1.2, ease:"easeInOut" }}
             className="hidden sm:flex gap-10">
                <a href="#home" className="cursor-pointer opacity-70 transition-all duration-300 hover:opacity-100 hover:scale-105">
                    <li title="Home">Home</li>
                </a>

                <a href="#tech" className="cursor-pointer opacity-70 transition-all duration-300 hover:opacity-100 hover:scale-105">
                    <li title="Tech">Tech</li>
                </a>

                <a href="#project" className="cursor-pointer opacity-70 transition-all duration-300 hover:opacity-100 hover:scale-105">
                    <li title="Project">Project</li>
                </a>
            ...
            transition={{duration:1.2, ease:"easeInOut" }}
             className="hidden sm:flex gap-5">
                ...
                <li className="cursor-pointer text-xl opacity-70 transition-all duration-300 hover:opacity-100 hover:text-blue-500">
                    <a title="Linkedin" target="_blank" href="https://www.linkedin.com/in/akram-ansari-55a68538a/">
                        <FaLinkedin />
                    </a>
                </li>
                ...
                <li className="cursor-pointer text-xl opacity-70 transition-all duration-300 hover:opacity-100">
                    <a title="Github" target="_blank" href="https://github.com/akramansari27923mah-dotcom">
                        <FaGithub />
                    </a>
                </li>
                <li className="cursor-pointer text-xl opacity-70 transition-all duration-300 hover:opacity-100 hover:text-pink-500">
                    <a title="Instagram" target="_blank" href="https://www.instagram.com/akram_ansari48/">
                        <FaInstagram />
                    </a>
                </li>
                <li className="cursor-pointer text-xl opacity-70 transition-all duration-300 hover:opacity-100 hover:text-sky-400">
            ...
            {
                isOpen ? (
                    <MdClose title="Close Menu" className="block md:hidden lg:hidden cursor-pointer" size={30} onClick={menuOpen} />
                ) : (
                    <GiHamburgerMenu title="Open Menu" className="block md:hidden sm:hidden lg:hidden cursor-pointer" size={30} onClick={menuOpen} />
                )
            }
