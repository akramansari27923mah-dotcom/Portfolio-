  ...
  return (
    <div id="home" className='flex w-full h-screen justify-center items-center text-white lg:mt-20 px-16 md:px-32'>
      ...
      <div className="flex justify-center items-center gap-y-5 flex-col">
        ...
        >
          <img className='w-60 h-60 object-cover rounded-[50%] transition-all duration-300 cursor-pointer shadow-xl shadow-indigo-900 hover:-translate-y-5' src="dp.jpg" />
        </motion.div>
        ...
        transition={{duration:0.5, delay:0.6}}
         className="flex flex-col justify-center items-center gap-y-2 max-w-180 text-center">
          ...
          <p className="md:text-base text-pretty text-sm hidden md:block text-gray-400">Hi, I’m Akram Ansari, a front-end web developer.
            ...
            I enjoy turning ideas into real-world projects and continuously improving my development skills.</p>
